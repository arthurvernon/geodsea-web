...
CREATE SEQUENCE BOAT.CLUB_ID_SEQ INCREMENT 1 MINVALUE 1 START 1 CACHE 1;
ALTER TABLE BOAT.CLUB_ID_SEQ OWNER TO geodsea;

CREATE TABLE BOAT.T_CLUB (
  ID              BIGINT      NOT NULL PRIMARY KEY DEFAULT nextval('BOAT.CLUB_ID_SEQ'),
  ORGANISATION_FK BIGINT      NOT NULL,
...
ALTER SEQUENCE BOAT.CLUB_ID_SEQ OWNED BY BOAT.T_CLUB.ID;
