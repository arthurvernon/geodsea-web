...
ALTER TABLE EPSG.alias OWNER TO geodsea;

CREATE TABLE EPSG.area (
...
ALTER TABLE EPSG.area OWNER TO geodsea;

CREATE TABLE EPSG.change (
...
action                                             VARCHAR(4000) );
ALTER TABLE EPSG.change OWNER TO geodsea;

CREATE TABLE EPSG.coordinateaxis (
...
ALTER TABLE EPSG.coordinateaxis OWNER TO geodsea;

CREATE TABLE EPSG.coordinateaxisname (
coord_axis_name_code                               INTEGER NOT NULL,
...
ALTER TABLE EPSG.coordinateaxisname OWNER TO geodsea;

CREATE TABLE EPSG.coordinatereferencesystem (
...
ALTER TABLE EPSG.coordinatereferencesystem OWNER TO geodsea;

CREATE TABLE EPSG.coordinatesystem (
coord_sys_code                                     INTEGER NOT NULL,
...
ALTER TABLE EPSG.coordinatesystem OWNER TO geodsea;

CREATE TABLE EPSG.coordoperation (
...
ALTER TABLE EPSG.coordoperation OWNER TO geodsea;

CREATE TABLE EPSG.coordoperationmethod (
...
ALTER TABLE EPSG.coordoperationmethod OWNER TO geodsea;

CREATE TABLE EPSG.coordoperationparam (
...
ALTER TABLE EPSG.coordoperationparam OWNER TO geodsea;

CREATE TABLE EPSG.coordoperationparamusage (
coord_op_method_code                               INTEGER NOT NULL,
parameter_code                                     INTEGER NOT NULL,
...
ALTER TABLE EPSG.coordoperationparamusage OWNER TO geodsea;

CREATE TABLE EPSG.coordoperationparamvalue (
coord_op_code                                      INTEGER NOT NULL,
coord_op_method_code                               INTEGER NOT NULL,
parameter_code                                     INTEGER NOT NULL,
...
ALTER TABLE EPSG.coordoperationparamvalue OWNER TO geodsea;

CREATE TABLE EPSG.coordoperationpath (
...
ALTER TABLE EPSG.coordoperationpath OWNER TO geodsea;

CREATE TABLE EPSG.datum (
...
ALTER TABLE EPSG.datum OWNER TO geodsea;

CREATE TABLE EPSG.deprecation (
...
ALTER TABLE EPSG.deprecation OWNER TO geodsea;

CREATE TABLE EPSG.ellipsoid (
...
ALTER TABLE EPSG.ellipsoid OWNER TO geodsea;

CREATE TABLE EPSG.namingsystem (
naming_system_code                                 INTEGER NOT NULL,
...
ALTER TABLE EPSG.namingsystem OWNER TO geodsea;

CREATE TABLE EPSG.primemeridian (
...
ALTER TABLE EPSG.primemeridian OWNER TO geodsea;

CREATE TABLE EPSG.supersession (
...
ALTER TABLE EPSG.supersession OWNER TO geodsea;

CREATE TABLE EPSG.unitofmeasure (
uom_code                                           INTEGER NOT NULL,
...
ALTER TABLE EPSG.unitofmeasure OWNER TO geodsea;

CREATE TABLE EPSG.versionhistory (
...
ALTER TABLE EPSG.versionhistory OWNER TO geodsea;
